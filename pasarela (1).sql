...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-09-2025 a las 16:21:25
...
INSERT INTO `carrito_compras` (`id_carrito`, `id_usuario`, `id_producto`, `cantidad`, `precio`, `fecha_agregado`) VALUES
(73, 1, 7, 2, 89, '2025-09-13 14:06:50');
...
(3, 'Monitor LED 24 pulgadas', 150.00, 9),
(4, 'Laptop Dell Inspiron 15', 599.00, 0),
(5, 'Auriculares JBL Tune 500', 50.00, 24),
(6, 'Camara Web HD', 39.00, 7),
(7, 'Disco Duro Externo 1TB', 89.00, 1);
...
INSERT INTO `usuario` (`id_usuario`, `Tipo_documento`, `nombre_usuario`, `apellido_usuario`, `fecha_registro`, `correo_usuario`, `password`, `id_roles`) VALUES
(1, NULL, 'Carlos', 'Quinones', '2025-08-30 18:20:12.109945', 'carlos.quinones@gmail.com', NULL, 2),
(2, NULL, 'Lucia', 'Martinez', '2025-08-26 18:26:06.710175', 'lucia.martinez@gmail.com', NULL, 1),
(3, NULL, 'Ana', 'Lopez', '2025-08-16 21:09:59.342764', 'ana.lopez@gmail.com', NULL, 3),
(4, NULL, 'Pedro', 'Ramirez', '2025-08-26 18:26:06.719609', 'pedro.ramirez@gmail.com', NULL, 1),
(5, NULL, 'Sofia', 'Torres', '2025-08-26 18:26:06.728913', 'sofia.torres@gmail.com', NULL, 2),
(6, NULL, 'Jorge', 'Vargas', '2025-08-16 21:09:59.342764', 'jorge.vargas@gmail.com', NULL, 3),
(7, NULL, 'Marta', 'Perez', '2025-08-26 18:26:06.738341', 'marta.perez@gmail.com', NULL, 3);
